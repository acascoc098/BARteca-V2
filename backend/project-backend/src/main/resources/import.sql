...
INSERT INTO `bar`(`nombre`, `provincia`, `ciudad`, `direccion`, `calificacion`, `telefono`, `correo`, `imagen`) VALUES ('Bar Antigua Cigarrería', 'Bilbao', 'Bilbao', 'Astarloa Kalea 5', 4, '944248973', 'bodegaantigua@example.com', 'https://verybilbao.com/wp-content/uploads/2016/09/antigua-cigarreria-1-1024x542.jpg');
