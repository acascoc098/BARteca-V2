...
INSERT INTO `bar`(`nombre`, `provincia`, `ciudad`, `direccion`, `calificacion`, `telefono`, `correo`) VALUES ('El Rincon', 'Valencia', 'Valencia', 'Calle de la Paz 10', 4, '963456789', 'elrincon@example.com');
INSERT INTO `bar`(`nombre`, `provincia`, `ciudad`, `direccion`, `calificacion`, `telefono`, `correo`) VALUES ('Cafe Moderno', 'Sevilla', 'Sevilla', 'Plaza Nueva 5', 4, '954321987', 'cafemoderno@example.com');
